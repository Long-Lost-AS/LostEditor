...
export const TilesetPanel = () => {
  ...
  }, [displayImage, currentTileset, mapData, selectedTileX, selectedTileY, pan, scale])
  ...
  const handleClick = (e: React.MouseEvent<HTMLCanvasElement>) => {
    ...
    if (
      x < 0 ||
      y < 0 ||
      x >= displayImage.width ||
      y >= displayImage.height
    ) {
  ...
  return (
    <div className="panel">
      ...
      {currentTileset && currentTileset.terrainLayers && currentTileset.terrainLayers.length > 0 && (
        <div className="mt-3">
          <div className="text-xs font-semibold mb-2" style={{ color: '#858585' }}>
            TERRAIN LAYERS
          </div>
          ...
          <div className="space-y-1">
            {currentTileset.terrainLayers.map((layer) => (
              <div
                ...
                style={{
                  background: selectedTerrainLayerId === layer.id ? '#0e639c' : '#2d2d2d',
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span
                    ...
                    style={{
                      color: selectedTerrainLayerId === layer.id ? '#ffffff' : '#cccccc'
                    }}
                  >
                    {layer.name}
                  </span>
