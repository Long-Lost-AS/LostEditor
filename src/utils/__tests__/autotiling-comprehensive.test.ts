...
describe("autotiling - comprehensive coverage", () => {
	...
	describe("applyAutotiling", () => {
		...
		it("should return null when tile definition not found in tileset", () => {
			const tileset: TilesetData = {
				...
				tiles: [
					// Tile at (16,0) exists
					{ id: packTileId(16, 0, 0), x: 16, y: 0, type: "grass" },
				],
				terrainLayers: [],
			};
		...
		it("should use getTileTerrainType for neighbor checking", () => {
			const tileset: TilesetData = {
				...
				tiles: [
					{ id: packTileId(16, 0, 0), x: 16, y: 0, type: "grass" },
					{ id: packTileId(32, 0, 0), x: 32, y: 0, type: "dirt" },
				],
				terrainLayers: [
					{
						id: "grass-layer",
	...
	describe("getTileTerrainType coverage (lines 35-50)", () => {
		...
		it("should handle tile definition not found via getTileTerrainType", () => {
			...
			const missingTile = packTileId(32, 0, 0);
	...
	describe("full bitmask matching path (lines 83-116)", () => {
				...
				terrainLayers: [
					{
						...
						tiles: [
							{ tileId: packTileId(16, 0, 0), bitmask: 16 }, // Center only
							{ tileId: packTileId(32, 0, 0), bitmask: 31 }, // Different bitmask
							{ tileId: packTileId(16, 0, 0), bitmask: 511 }, // All neighbors
						],
					},
				],
		...
		it("should return currentTileId when no bitmask match (line 116)", () => {
			const tileset: TilesetData = {
				...
				tileWidth: 16,
				tileHeight: 16,
				tiles: [{ id: packTileId(16, 0, 0), x: 16, y: 0, type: "grass" }],
				terrainLayers: [
					{
						id: "grass-layer",
						name: "grass",
				...
				terrainLayers: [
					{
						...
						name: "grass",
						tiles: [
							{ tileId: packTileId(16, 0, 0), bitmask: 16 }, // Center tile
						],
					},
				],
			};
